...
public class UserPage extends AbstractPage {
    ...
    public void render() {
        ...
        // Render
        SkijaFontRenderer noto = SkijaFontLoader.noto;
        ...
        if (qrCode != null) {
            ...
            noto.drawCenteredString(text, centerX, scrolledY + 20f, 25f, Color.WHITE, false);
            RenderUtil.drawImage(qrCode.getImage(), centerX - 64f, scrolledY + 50f, 128f, 128f);
        } else if (user.getNickname() == null) {
            noto.drawCenteredString("请稍后……", centerX, scrolledY + 20f, 25f, Color.WHITE, false);
        } else {
            RenderUtil.bindTexture(user.getAvatarImage());
            ShaderUtil.drawRoundTextured(centerX - 20f, scrolledY + 20f, 40f, 40f, 20f, 1f);
            noto.drawCenteredString(user.getNickname(), centerX, scrolledY + 70f, 20f, Color.WHITE, false);
            noto.drawCenteredString(user.getSignature(), centerX, scrolledY + 85f, 15f, Theme.grey, true);
            ...
            noto.drawCenteredString("lv." + user.getLevel() + "  |  听过 " + user.getListenedSongs() + " 首歌  |  村龄 " + age, centerX, scrolledY + 95f, 15f, Theme.grey, false);
        }
        postDraw();
    }
