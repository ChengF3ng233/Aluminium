...
public class UserPage extends AbstractPage {
    ...
    public void render() {
        ...
        if (qrCode != null) {
            ...
            noto.drawCenteredString("请稍侯……", centerX, scrolledY + 20f, Color.WHITE, CenterType.Horizontal);
        } else {
            ...
            AWTFontLoader.noto(15f).drawCenteredString(user.getSignature(), centerX, scrolledY + 85f, Theme.grey, CenterType.Horizontal);
            ...
            AWTFontLoader.noto(15f).drawCenteredString("lv." + user.getLevel() + "  |  听过 " + user.getListenedSongs() + " 首歌  |  村龄 " + age, centerX, scrolledY + 95f, Theme.grey, CenterType.Horizontal);
        }
        animateEnd();
    }
    ...
    public void logout() {
        new Thread(() -> {
            ...
            MusicApi.logout();
            Aluminium.INSTANCE.musicManager.getScreen().setCurrentPage(this);
        }).start();
    }
}
